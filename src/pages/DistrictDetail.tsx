...
type SectionKey = "places" | "food" | "culture" | "hotels" | "bus";
...
const DistrictDetail = () => {
  ...
  const [activeSection, setActiveSection] = useState<SectionKey>("places");
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
          {([
            { key: "places", icon: MapPin, label: "Places to Visit", color: "text-primary" },
            { key: "food", icon: Utensils, label: "Food", color: "text-accent" },
            { key: "culture", icon: Calendar, label: "Culture", color: "text-primary" },
            { key: "hotels", icon: Building, label: "Hotels", color: "text-accent" },
            { key: "bus", icon: Bus, label: "Bus Stands", color: "text-primary" },
            ...
            return (
              <Card
                ...
                className={`p-4 text-center bg-gradient-card hover:shadow-glow transition-all cursor-pointer group ${
